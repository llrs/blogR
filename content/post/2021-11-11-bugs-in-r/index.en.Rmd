...
summary: 'Bug reports are quite healthy if people continue contributing.'
---
...
I knew about the r-devel (abbreviated Rd) mailing list that is where some discussions about the language happen and
I had read that post of the [R core requesting help reviewing bug reports](https://developer.r-project.org/Blog/public/2019/10/09/r-can-use-your-help-reviewing-bug-reports/index.html) and I had [requested an account](https://www.r-project.org/bugs.html) the same day it came out to be able to post on [Bugzilla: https://bugs.r-project.org/](https://bugs.r-project.org/).
...
- Impact on the load of the machine.
...
It was suggested on that meeting to present a Google Summer of Code project[^1] which closed the project submission period shortly after.
...
1: A program from Google where they sponsor students and organizations to work on open source projects. I didn't knew R participated, but here is the [organization on Github](https://github.com/rstats-gsoc).
...
Probably spamers abused the Bugzilla's API. 
Is understandable that the R core team is concerned on receiving spam messages from those past experiences.
