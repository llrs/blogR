...
This could indicate problems following CRAN policies, keeping up to date wit changes in R code and checks.
...
See general days without acceptance of packages
...
packages2 |> 
  ...
  tidyr::pivot_longer(c(direct_deps, r_deps), names_to = "dependency") |> 
