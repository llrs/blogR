...
Correction! Some reviewers have the issues not approved closed later. They might wait longer to close the issues without approving them, or maybe they prefer to suggest modifications and a later second submission. 
...
If the review starts the next halting point is an error on the build process.
