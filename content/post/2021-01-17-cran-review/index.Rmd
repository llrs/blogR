...
After this first reading and preliminary cleanup we start.
...
The period we are going to analyze is from the beginning of the records till 2021/01/16.
...
I found that some packages are in multiple folders (2 or even 3) at the same time:
...
But perhaps this indicates further improvements of the process could be done.
...
[^2]: I don't know the list of the reviewers, just
...
It might mean that it is an abandoned or rejected submissions like [knitcitations](https://github.com/cboettig/knitcitations/issues/107#issuecomment-736069214), other might be acceptances in less than an hour[^3].
...
So the script and github actions worked on \~97.84% of the times. 
